...
class bm_sanitizer {
	...
	public function get_sanitized_settings_field( $field, $value ) {
		switch ( $field ) {
			case 'bm_logout_prompt_text':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_wpadmin_allow_ips':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_blocked_ips':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_blocked_emails':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_blacklist_word':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_account_deletion_alert_text':
				$value = sanitize_textarea_field( $value );
				break;
			case 'bm_recaptcha_site_key':
				$value = sanitize_text_field( $value );
				break;
			case 'bm_recaptcha_secret_key':
				$value = sanitize_text_field( $value );
				break;
			case 'bm_account_review_email_subject':
				$value = sanitize_text_field( $value );
				break;
			case 'bm_account_delete_email_subject':
				$value = sanitize_text_field( $value );
				break;
			...
			case 'bm_from_email_address':
				$value = sanitize_email( $value );
				break;
			case 'bm_paypal_email':
				$value = sanitize_email( $value );
				break;
			case 'bm_account_review_email_body':
				$value = wp_kses_post( $value );
				break;
			case 'bm_account_delete_email_body':
				$value = wp_kses_post( $value );
				break;
			case 'bm_unread_message_email_body':
				$value = wp_kses_post( $value );
				break;
			case 'bm_activation_email_body':
				$value = wp_kses_post( $value );
				break;
			...
			case 'pg_user_profile_seo_desc':
				$value = wp_kses_post( $value );
				break;
			case 'bm_blog_notification_email_body':
				$value = wp_kses_post( $value );
				break;
			case 'bm_new_user_create_admin_email_body':
				$value = wp_kses_post( $value );
				break;
			case 'bm_user_profile_base':
